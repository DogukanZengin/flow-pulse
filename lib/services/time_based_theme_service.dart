...
class TimeOfDayColors {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! TimeOfDayColors) return false;
    return primaryGradient == other.primaryGradient &&
           secondaryGradient == other.secondaryGradient &&
           particleColors == other.particleColors &&
           ambientOpacity == other.ambientOpacity &&
           description == other.description;
  }
  
  @override
  int get hashCode {
    return primaryGradient.hashCode ^
           secondaryGradient.hashCode ^
           particleColors.hashCode ^
           ambientOpacity.hashCode ^
